...
/**
 * MySQLForeignKeyDefinition
 * 
 * MySQL-specific implementation of foreign key definitions
 */
class MySQLForeignKeyDefinition implements ForeignKeyDefinitionInterface
{
    ...
    public function __construct(MySQLSchemaBuilder $schemaBuilder, string $column)
    {
